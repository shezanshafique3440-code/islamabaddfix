            ...
            >
              <div
                className={cn(
                  ...
                  message.isMine
                    ? 'bg-brand-700 text-white dark:text-brand-50'
      ...
      {closed ? (
        ...
        >
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-ink-300 px-3.5 py-2.5 text-sm text-ink-900 placeholder:text-ink-500 hover:border-ink-400 focus:border-brand-600"
          />
